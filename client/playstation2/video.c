...
#define GIF_TAG(nloop, eop, pre, prim, flg, nreg)                                                            \
    ((uint64_t)(nloop) | ((uint64_t)(eop) << 15) | ((uint64_t)(pre) << 46) | ((uint64_t)(prim) << 47) |      \
...
#define GS_SET_PRIM(prim, iip, tme, fge, abe, aa1, fst, ctxt, fix)                                           \
    ((uint64_t)(prim) | ((uint64_t)(iip) << 3) | ((uint64_t)(tme) << 4) | ((uint64_t)(fge) << 5) |           \
     ((uint64_t)(abe) << 6) | ((uint64_t)(aa1) << 7) | ((uint64_t)(fst) << 8) | ((uint64_t)(ctxt) << 9) |    \
     ((uint64_t)(fix) << 10))
...
#define GS_SET_XYZ(x, y, z) ((uint64_t)(x) | ((uint64_t)(y) << 16) | ((uint64_t)(z) << 32))
...
#define GS_SET_FRAME(fbp, fbw, psm, fbmsk)                                                                   \
    ((uint64_t)(fbp) | ((uint64_t)(fbw) << 16) | ((uint64_t)(psm) << 24) | ((uint64_t)(fbmsk) << 32))

/* Pack a SCISSOR_1 register value */
#define GS_SET_SCISSOR(scax0, scax1, scay0, scay1)                                                           \
    ((uint64_t)(scax0) | ((uint64_t)(scax1) << 16) | ((uint64_t)(scay0) << 32) | ((uint64_t)(scay1) << 48))
 ...
 */
static void gs_fill_rect(int x, int y, int w, int h, uint8_t r, uint8_t g, uint8_t b) {
...
void ps2_video_init(void) {
    ...
    GS_DISPLAY1 = (uint64_t)652 | ((uint64_t)50 << 12) | ((uint64_t)3 << 23) | ((uint64_t)0 << 27) |
                  ((uint64_t)2559 << 32) | ((uint64_t)479 << 44);
 ...
 */
static void ps2_video_draw_char(int x, int y, char c, uint8_t r, uint8_t g, uint8_t b) {
