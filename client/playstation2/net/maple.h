/* client/playstation2/net/maple.h */
/*
 * Stub Maple Bus header for PlayStation 2.
 * The Dreamcast Maple bus does not exist on PS2.
...
{
    static unsigned char no_maple_response[4] = {
        (unsigned char)MAPLE_RESPONSE_BADCMD, 0, 0, 0
    };
