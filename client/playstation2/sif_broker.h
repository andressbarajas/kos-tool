...
typedef struct kosload_sif_ops {
    ...
    int  (*register_cmd_handler)(uint32_t cid,
                                 void (*h)(const void *pkt, uint32_t len,
                                           void *arg),
                                 void *arg);
    ...
    int  (*rpc_call)(kosload_sif_client_t *c, uint32_t fno,
    ...
    int  (*load_module_buffer)(kosload_sif_client_t *c,
    ...
    int (*load_module_path)(kosload_sif_client_t *c,
                            const char *path,
                            const char *args, uint32_t args_len);
