/* client/dreamcast/memfuncs.h */
#ifndef __MEMFUNCS_H__
#define __MEMFUNCS_H__

/*
 * Copied from dcload-ip: dcload-ip/target-src/dcload/memfuncs.h
 *
