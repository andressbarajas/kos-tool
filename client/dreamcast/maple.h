/* client/dreamcast/maple.h */
#ifndef KOSLOAD_DC_MAPLE_H
#define KOSLOAD_DC_MAPLE_H

/*
 * Copied from dcload-ip: dcload-ip/target-src/dcload/maple.h
 *
