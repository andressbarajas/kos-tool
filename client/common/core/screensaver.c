...
static const uint32_t screensaver_icon[32] = {
    0x00000000, 0x01F00000, 0x03FC0600, 0x01FE0F00, 0x01FF1F00, 0x00FF9E00, 0x007FB800, 0x001FB000,
    0x0007E000, 0x03F9CFC0, 0x07FFFFE0, 0x0FFFFFF0, 0x1F87E1F8, 0x1F87C1F8, 0x3F8783FC, 0x3F8707FC,
    0x3F860FFC, 0x3F841FFC, 0x3F803FFC, 0x3F807FFC, 0x3F803FFC, 0x3F841FFC, 0x1F860FFC, 0x1F8707FC,
    0x0F8783F8, 0x0F87C1F8, 0x0787E0F0, 0x0387F0E0, 0x01FFFFC0, 0x00FFFF80, 0x007FFF00, 0x003E3E00,
};
...
void screensaver_poll(void) {
    ...
    if(!active) {
        ...
        box_dy = 2;
        last_frame = now;
        t->draw_bitmap(box_x, box_y, ICON_SIZE, ICON_SIZE, screensaver_icon, 0xffff);
        return;
    }
    ...
    t->draw_bitmap(box_x, box_y, ICON_SIZE, ICON_SIZE, screensaver_icon, icon_color_saved);
}
