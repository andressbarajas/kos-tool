...
static inline size_t compat_str_copy_bytes(char *dst, size_t dst_size,
...
static inline size_t compat_str_append_bytes(char *dst, size_t dst_size,
                                             size_t pos, const void *src,
                                             size_t src_size)
{
...
static inline size_t compat_str_append(char *dst, size_t dst_size, size_t pos,
                                       const char *src)
{
    if (!src)
        src = "";
...
static inline void compat_path_join(char *dst, size_t dst_size,
