...
/* Network syscall command IDs (4-byte ASCII) */
#define NET_CMD_EXIT      "DC00"
#define NET_CMD_FSTAT     "DC01"
#define NET_CMD_WRITE_OLD "DD02"    /* Legacy write command */
#define NET_CMD_WRITE     "DC02"
#define NET_CMD_READ      "DC03"
#define NET_CMD_OPEN      "DC04"
#define NET_CMD_CLOSE     "DC05"
#define NET_CMD_CREAT     "DC06"
#define NET_CMD_LINK      "DC07"
#define NET_CMD_UNLINK    "DC08"
#define NET_CMD_CHDIR     "DC09"
#define NET_CMD_CHMOD     "DC10"
#define NET_CMD_LSEEK     "DC11"
#define NET_CMD_TIME      "DC12"
#define NET_CMD_STAT      "DC13"
#define NET_CMD_UTIME     "DC14"
#define NET_CMD_BAD       "DC15"
#define NET_CMD_OPENDIR   "DC16"
#define NET_CMD_CLOSEDIR  "DC17"
#define NET_CMD_READDIR   "DC18"
...
#define ADAPTER_DC_W5500    0x0500  /* Dreamcast W5500 (SCIF-SPI) */
#define ADAPTER_GC_USBGECKO 0x0500  /* GameCube USBGecko */
#define ADAPTER_GC_BBA      0x0600  /* GameCube Broadband Adapter */
#define ADAPTER_GC_W5500    0x0700  /* GameCube W5500 (EXI-SPI) */
